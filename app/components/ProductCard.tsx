    ...
    return(
        <div className="rounded-lg">
            ...
            <div className="flex justify-between items-center mt-2">
                ...
                <h3 className="inline-flex items-center rounded-md bg-primary/10 px-2 py-1 text-xs font-medium text-primary ring-1 ring-inset ring-primary/10">Rs. {price}</h3>
            </div>
...
export function LoadingProductCard(){
    return(
        <div className="flex flex-col">
            ...
            <Skeleton className="w-full h-1- mt-5" />
        </div>
    )
}