...
async function LoadRows({category}: iAppProps){
    ...
    return (
        ...
        <div className="md:flex md:items-center md:justify-between">
                ...
                <Link href={data.link} className="text-sm hidden font-medium text-primary hover:text-primary/90 md:block">All Products <span>&rarr;</span></Link>
            </div>
...
function LoadingState(){
    return(
        <div>
            ...
            <div className="gird grid-cols-1 sm:grid-cols-2 mt-4 gap-10 lg:grid-cols-3">
                <LoadingProductCard />
                <LoadingProductCard />
                <LoadingProductCard />
            </div>
